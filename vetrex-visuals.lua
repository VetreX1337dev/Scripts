...
VisualsTab:CreateColorPicker({
   ...
   Callback = function(color) hatColor = color; if hatEnabled and not hatRainbow then updateHats() end end
})
...
-- ======================================================
OtherTab:CreateSection("Movement")
